...
const OfferCard: FC<OfferCardProps> = (props) => {
  ...
  return (
    <div className="uam_offerCard">
      <div className="uam_offerCardWrapper">
        <div className="uam_offerCard_titleWrapper">
          <div className="uam_offerCard_titleWrapper_content">
            <h5 className="uam_offerCard_titleWrapper_title">{title}</h5>
            <p className="uam_offerCard_titleWrapper_subtitle">{subtitle}</p>
            <em>{condition}</em>
          </div>
          <button className="uam_offerCard_titleWrapper_button">
            <i className="site-line_arrow"></i>
          </button>
        </div>
        <Image
          src={imageSrc}
      ...
      <div className="uam_offerCard_descriptionContainer">
        <p className="uam_offerCard_descriptionContainer_description">
          {description}
        </p>
